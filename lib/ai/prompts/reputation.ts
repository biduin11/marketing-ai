...
При поиске компании используй ВСЕ возможные варианты написания:
- Точное название из анкеты
- Транслитерацию (если название на русском)
- Без пробелов и с пробелами
- С добавлением города

Примеры поисковых запросов для "Фин Кровля" в Махачкале:
- "Фин Кровля Махачкала отзывы"
- "Фин Кровля Махачкала Яндекс Карты"
- "fin-krovlya.ru отзывы"
- "кровельные материалы Махачкала Фин Кровля"
- site:yandex.ru/maps "Фин Кровля"
- site:2gis.ru "Фин Кровля Махачкала"

Также попробуй найти по URL сайта если он указан в анкете.
